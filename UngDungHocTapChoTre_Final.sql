...
('DA2661', 'CH311', N'đọc', 1),
('DA2662', 'CH311', N'Bé', 0),
('DA2663', 'CH311', N'Lan', 0),
('DA2664', 'CH311', N'sách', 0),

-- CH312: Bạn nhỏ rất ___ → "vui"
('DA2665', 'CH312', N'vui', 1),
('DA2666', 'CH312', N'chạy', 0),
('DA2667', 'CH312', N'cao', 0),
('DA2668', 'CH312', N'đọc', 0),

-- CH313: Trái nghĩa với "mạnh" → "yếu"
('DA2669', 'CH313', N'yếu', 1),
('DA2670', 'CH313', N'nhanh', 0),
('DA2671', 'CH313', N'đẹp', 0),
('DA2672', 'CH313', N'cao', 0),

-- CH314: Từ viết đúng: "khỏe"
('DA2673', 'CH314', N'khỏe', 1),
('DA2674', 'CH314', N'khoẻ~', 0),
('DA2675', 'CH314', N'khỏe~', 0),
('DA2676', 'CH314', N'khoẽ', 0),

-- CH315: Thời tiết thật ___ → "đẹp"
('DA2677', 'CH315', N'đẹp', 1),
('DA2678', 'CH315', N'chạy', 0),
('DA2679', 'CH315', N'bé', 0),
('DA2680', 'CH315', N'bàn', 0),

-- CH316: Danh từ → "con đường"
('DA2681', 'CH316', N'con đường', 1),
('DA2682', 'CH316', N'cao', 0),
('DA2683', 'CH316', N'ăn', 0),
('DA2684', 'CH316', N'ngủ', 0),

-- CH317: "chuẩn bị" là động từ
('DA2685', 'CH317', N'động từ', 1),
('DA2686', 'CH317', N'danh từ', 0),
('DA2687', 'CH317', N'tính từ', 0),
('DA2688', 'CH317', N'đại từ', 0),

-- CH318: Cố gắng ___ bài toán → "giải"
('DA2689', 'CH318', N'giải', 1),
('DA2690', 'CH318', N'đẹp', 0),
('DA2691', 'CH318', N'ăn', 0),
('DA2692', 'CH318', N'xanh', 0),

-- CH319: Danh từ trong câu là: "ông", "cây"
-- Chọn danh từ phù hợp nhất → "ông"
('DA2693', 'CH319', N'ông', 1),
('DA2694', 'CH319', N'đang', 0),
('DA2695', 'CH319', N'tưới', 0),
('DA2696', 'CH319', N'em', 0),

-- CH320: Bé Hoa rất ___ → "vui"
('DA2697', 'CH320', N'vui', 1),
('DA2698', 'CH320', N'chạy', 0),
('DA2699', 'CH320', N'ăn', 0),
('DA2700', 'CH320', N'cao', 0),

-- CH321: Trái nghĩa của "cao" → "thấp"
('DA2701', 'CH321', N'thấp', 1),
('DA2702', 'CH321', N'đẹp', 0),
('DA2703', 'CH321', N'nhanh', 0),
('DA2704', 'CH321', N'nóng', 0),

-- CH322: Từ đúng chính tả → "nghỉ ngơi"
('DA2705', 'CH322', N'nghỉ ngơi', 1),
('DA2706', 'CH322', N'nghỉ ngơi~', 0),
('DA2707', 'CH322', N'nghĩ ngơi', 0),
('DA2708', 'CH322', N'ngĩ ngơi', 0),

-- CH323: Cả lớp đang ___ bài hát → "hát"
('DA2709', 'CH323', N'hát', 1),
('DA2710', 'CH323', N'đỏ', 0),
('DA2711', 'CH323', N'vui', 0),
('DA2712', 'CH323', N'chạy', 0),

-- CH324: Tính từ → "đẹp"
('DA2713', 'CH324', N'đẹp', 1),
('DA2714', 'CH324', N'mèo', 0),
('DA2715', 'CH324', N'ăn', 0),
('DA2716', 'CH324', N'bút', 0),

-- CH325: "chăm chỉ" là tính từ
('DA2717', 'CH325', N'tính từ', 1),
('DA2718', 'CH325', N'động từ', 0),
('DA2719', 'CH325', N'danh từ', 0),
('DA2720', 'CH325', N'thán từ', 0),

-- CH326: Chiếc áo này rất ___ → "đẹp"
('DA2721', 'CH326', N'đẹp', 1),
('DA2722', 'CH326', N'chạy', 0),
('DA2723', 'CH326', N'uống', 0),
('DA2724', 'CH326', N'ngủ', 0),

-- CH327: Trái nghĩa của "buồn" → "vui"
('DA2725', 'CH327', N'vui', 1),
('DA2726', 'CH327', N'to', 0),
('DA2727', 'CH327', N'mới', 0),
('DA2728', 'CH327', N'thấp', 0),

-- CH328: "nấu" là động từ
('DA2729', 'CH328', N'động từ', 1),
('DA2730', 'CH328', N'danh từ', 0),
('DA2731', 'CH328', N'tính từ', 0),
('DA2732', 'CH328', N'thán từ', 0),

-- CH329: Bạn nhỏ ___ tay chào → "vẫy"
('DA2733', 'CH329', N'vẫy', 1),
('DA2734', 'CH329', N'xanh', 0),
('DA2735', 'CH329', N'ăn', 0),
('DA2736', 'CH329', N'đẹp', 0),

-- CH330: Danh từ → "quyển sách"
('DA2737', 'CH330', N'quyển sách', 1),
('DA2738', 'CH330', N'vui', 0),
('DA2739', 'CH330', N'chạy', 0),
('DA2740', 'CH330', N'đỏ', 0),
