...
public class CauHoiActivity2 extends AppCompatActivity {
    ...
    private void bindUI() {
        ...
        findViewById(R.id.imgVuongMieng).setOnClickListener(v -> {
            Intent intent = new Intent(CauHoiActivity2.this,
        ...
        api.getCauHoiBaiLam(maBaiLam).enqueue(new Callback<List<CauHoiDapAnResponse>>() {
            ...
            public void onResponse(Call<List<CauHoiDapAnResponse>> call, Response<List<CauHoiDapAnResponse>> res) {
                ...
                if (!res.isSuccessful() || res.body() == null) {
                    Toast.makeText(CauHoiActivity2.this, "Không tải được câu hỏi!", Toast.LENGTH_SHORT).show();
                    finish();
                    return;
                }
            ...
            public void onFailure(Call<List<CauHoiDapAnResponse>> call, Throwable t) {
                Toast.makeText(CauHoiActivity2.this, "Lỗi API: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
    ...
    private void hienThiCauHoi() {
        ...
        for (Button b : arr) {
            b.setOnClickListener(v -> {
                ...
                tintButton(btnTiepTuc, Color.parseColor("#0EA113"));
            });
        }
    ...
    private void hoanThanhBaiLam() {
        ...
        api.hoanThanh(
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(CauHoiActivity2.this, "Không thể cập nhật tiến trình!", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
