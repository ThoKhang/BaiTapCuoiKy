...
public class NhapDapAnTrumTinhNham extends AppCompatActivity {
    ...
    private TrumTinhNhamViewModel trumTinhNhamViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nhap_dap_an_trum_tinh_nham);
        ...
        trumTinhNhamViewModel = new ViewModelProvider(this).get(TrumTinhNhamViewModel.class);
        trumTinhNhamViewModel.deTinhNham.observe(this,de->{
            if(de!=null){
        ...
        trumTinhNhamViewModel.loadDeTinhNham();
