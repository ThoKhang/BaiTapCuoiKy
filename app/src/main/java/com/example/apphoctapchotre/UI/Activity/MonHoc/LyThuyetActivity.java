...
import com.example.apphoctapchotre.UI.ViewModel.LyThuyetViewModel;
...
public class LyThuyetActivity extends AppCompatActivity {
    ...
    private LyThuyetViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ly_thuyet_mon_hoc1);
        ...
        viewModel = new ViewModelProvider(this).get(LyThuyetViewModel.class);
    ...
    private void openMon(String maMon) {
        Intent intent = new Intent(this, LyThuyetActivity2.class);
