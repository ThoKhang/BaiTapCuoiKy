...
public class NhapDapAnHoanThienCauTu extends AppCompatActivity {
    ...
    private HoanThienCauTuViewModel hoanThienCauTuViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nhap_dap_an_hoan_thien_cau_tu);
        ...
        hoanThienCauTuViewModel = new ViewModelProvider(this).get(HoanThienCauTuViewModel.class);
        hoanThienCauTuViewModel.deHoanThien.observe(this,de->{
            if(de!=null){
        ...
        hoanThienCauTuViewModel.loadDeHoanThien();
        btnTiepTuc.setOnClickListener(v->{
            ...
            if (soCau < danhSach.size() - 1) {
                ...
                Toast.makeText(this, "Hoàn thành hoàn thiện câu từ!", Toast.LENGTH_SHORT).show();
