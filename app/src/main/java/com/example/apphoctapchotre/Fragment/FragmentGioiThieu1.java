...
public class FragmentGioiThieu1 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_gioi_thieu1, container, false); // Đảm bảo tên layout đúng
        ...
        // Xử lý nút Back nếu cần (ví dụ: quay về Splash hoặc đóng app)
        // ImageButton ibtnBack = view.findViewById(R.id.ibtnBack);
        // ibtnBack.setOnClickListener(v -> getActivity().finish());
