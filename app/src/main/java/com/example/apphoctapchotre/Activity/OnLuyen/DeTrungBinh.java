...
public class DeTrungBinh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<com.example.apphoctapchotre.model.ui.DeItem> list = new ArrayList<>();
        list.add(new com.example.apphoctapchotre.model.ui.DeItem("Đề trung bình số 1", 80, 9, 10));
        for (int i = 2; i <= 10; i++) {
            list.add(new com.example.apphoctapchotre.model.ui.DeItem("Đề trung bình số " + i, 80, 0, 10));
        }
