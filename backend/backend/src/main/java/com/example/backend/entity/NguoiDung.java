...
public class NguoiDung {
    ...
    private Integer soLanTrucTuyen;
    ...
    public Integer getSoLanTrucTuyen() {
        return soLanTrucTuyen;
    }

    public void setSoLanTrucTuyen(Integer soLanTrucTuyen) {
        this.soLanTrucTuyen = soLanTrucTuyen;
    }
