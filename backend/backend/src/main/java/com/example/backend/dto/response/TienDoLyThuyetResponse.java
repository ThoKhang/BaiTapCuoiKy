...
public class TienDoLyThuyetResponse {
    private String maMonHoc;
    private String tenMonHoc;
    private int soDaHoc;
    private int tongSoBai;

    public TienDoLyThuyetResponse() { }

    public TienDoLyThuyetResponse(String maMonHoc, String tenMonHoc, int soDaHoc, int tongSoBai) {
    ...
    public int getSoDaHoc() { return soDaHoc; }
    public void setSoDaHoc(int soDaHoc) { this.soDaHoc = soDaHoc; }
